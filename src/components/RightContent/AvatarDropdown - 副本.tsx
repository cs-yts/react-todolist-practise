...
import { getTodoLists } from '@/services/todu';
...
const AvatarDropdown: React.FC<GlobalHeaderRightProps> = ({ menu }, props) => {
...
export default connect(({ todoL }) => ({ todoL }))(AvatarDropdown);

// export default connect(({ todoL }) => ({
//   todoL,
// }))(AvatarDropdown);
